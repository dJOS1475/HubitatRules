...
//    cmds += zigbee.readAttribute(0xFCC0, 0x019A, [mfgCode: 0x115F], delay=200)   // Read detection range
    ...
    // Suspected to help keep FP300 firmware 0.0.0_6542 from leaving the network.
    cmds += zigbee.readAttribute(0xFCC0, 0x0142, [mfgCode: 0x115F], delay=200)   // read current presence
    ...
    cmds += zigbee.configureReporting(0xFCC0, 0x0142, 0x20, 0, 1800, 1, [mfgCode: 0x115F], delay=50)    // Configure presence (0x0142) reporting: min=0s, max=1800s (heartbeat), change=1
    cmds += zigbee.configureReporting(0xFCC0, 0x014D, 0x20, 0, 1800, 1, [mfgCode: 0x115F], delay=50)    // Configure PIR detection (0x014D) reporting: min=0s, max=1800s (heartbeat), change=1
